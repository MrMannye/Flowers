...
function App() {
  const song = new Audio("../public/flowers-song.mp3")

  useEffect(() => {
    song.volume = 0.5;               // Volumen al 50%
    console.log(song.paused);        // true (no se está reproduciendo)
    console.log(song.currentTime);   // 0
    console.log(song.duration);      // 17.81551 (17 secs, 815.51 ms)
    song.play(); 
    ...
    <>
        ...
        <div className="flowers">
          <div className="flower flower--1">
            <div className="name">YARIMARIEL</div>
